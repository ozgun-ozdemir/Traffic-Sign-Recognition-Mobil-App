...
public final class TrafficSignModel {
  @NonNull
  private final Model model;

  private TrafficSignModel(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    model = Model.createModel(context, "traffic_sign_model.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static TrafficSignModel newInstance(@NonNull Context context) throws IOException {
    return new TrafficSignModel(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static TrafficSignModel newInstance(@NonNull Context context,
      @NonNull Model.Options options) throws IOException {
    return new TrafficSignModel(context, options);
  }
