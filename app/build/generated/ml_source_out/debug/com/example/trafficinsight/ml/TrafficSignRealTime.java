package com.example.trafficinsight.ml;
...
public final class TrafficSignRealTime {
  @NonNull
  private final Model model;

  private TrafficSignRealTime(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    model = Model.createModel(context, "traffic_sign_real_time.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static TrafficSignRealTime newInstance(@NonNull Context context) throws IOException {
    return new TrafficSignRealTime(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static TrafficSignRealTime newInstance(@NonNull Context context,
      @NonNull Model.Options options) throws IOException {
    return new TrafficSignRealTime(context, options);
  }
